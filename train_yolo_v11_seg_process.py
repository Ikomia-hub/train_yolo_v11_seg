...
# --------------------
class TrainYoloV11SegParam(TaskParam):
...
# --------------------
class TrainYoloV11Seg(dnntrain.TrainProcess):
    ...
    def __init__(self, name, param):
        ...
        if param is None:
            self.set_param_object(TrainYoloV11SegParam())
        else:
...
# --------------------
class TrainYoloV11SegFactory(dataprocess.CTaskFactory):

    def __init__(self):
        dataprocess.CTaskFactory.__init__(self)
        # Set algorithm information/metadata here
        self.info.name = "train_yolo_v11_seg"
        ...
        self.info.repository = "https://github.com/Ikomia-hub/train_yolo_v11_seg"
    ...
    def create(self, param=None):
        ...
        return TrainYoloV11Seg(self.info.name, param)
