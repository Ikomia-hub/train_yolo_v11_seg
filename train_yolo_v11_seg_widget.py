...
from train_yolo_v11_seg.train_yolo_v11_seg_process import TrainYoloV11SegParam
...
# --------------------
class TrainYoloV11SegWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV11SegParam()
        else:
        ...
        self.combo_model.addItem("yolo11n-seg")
        self.combo_model.addItem("yolo11s-seg")
        self.combo_model.addItem("yolo11m-seg")
        self.combo_model.addItem("yolo11l-seg")
        self.combo_model.addItem("yolo11x-seg")
...
# --------------------
class TrainYoloV11SegWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        self.name = "train_yolo_v11_seg"

    def create(self, param):
        # Create widget object
        return TrainYoloV11SegWidget(param, None)
